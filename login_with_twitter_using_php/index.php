...
//else if the user had not authorized app. First time
elseif(isset($_REQUEST['oauth_token']) && $_SESSION['token'] == $_REQUEST['oauth_token']){
	...
	if($twClient->http_code == '200'){
		...
		$output = '<a href="'.filter_var($authUrl, FILTER_SANITIZE_URL).'"><img src="images/sign-in-with-twitter-gray.png" width="158" height="28" border="0" /></a>';
	}else{
